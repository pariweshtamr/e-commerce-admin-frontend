          ...
          <ul className="menu-items">
            ...
            <li>
              <NavLink
                ...
                to="/categories"
              >
                <i className="fas fa-sitemap me-3"></i>Categories
              </NavLink>
            </li>
            <li>
              <NavLink
                ...
                to="/products"
              >
                <i className="fas fa-boxes me-3"></i>Products
              </NavLink>
            </li>
            <li>
              <NavLink
                ...
                to="/orders"
              >
                <i className="fas fa-sort-amount-up-alt me-3"></i>Orders
              </NavLink>
            </li>
            <li>
              <NavLink
                ...
                to="/customers"
              >
                <i className="fas fa-users me-3"></i>Customers
              </NavLink>
            </li>
            <li>
              <NavLink
